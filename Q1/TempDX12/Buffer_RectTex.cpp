...
HRESULT CBuffer_RectTex::Ready_VIBuffer()
{
	...
	VTXTEX pVertices[4];
	pVertices[0] =VTXTEX(XMFLOAT3(-0.5f, 0.5f, 0.f), XMFLOAT2(1.0f, 0.0f));
	pVertices[1] =VTXTEX(XMFLOAT3(0.5f, 0.5f, 0.f), XMFLOAT2(1.0f, 0.0f));
	pVertices[2] =VTXTEX(XMFLOAT3(0.5f, -0.5f, 0.f), XMFLOAT2(0.0f, 0.0f));
	pVertices[3] =VTXTEX(XMFLOAT3(-0.5f, -0.5f, 0.f), XMFLOAT2(0.0f, 0.0f));
