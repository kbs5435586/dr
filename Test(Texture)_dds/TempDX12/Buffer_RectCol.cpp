...
HRESULT CBuffer_RectCol::Ready_VIBuffer()
{
	...
	VTXCOL pVertices[4];
	pVertices[0] = VTXCOL(XMFLOAT3(-0.5f, 0.5f, 0.f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.f));
	pVertices[1] = VTXCOL(XMFLOAT3(-0.5f, -0.5f, 0.f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.f));
	pVertices[2] = VTXCOL(XMFLOAT3(0.5f, -0.5f, 0.f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.f));
	pVertices[3] = VTXCOL(XMFLOAT3(0.5f, 0.5f, 0.f), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.f));

	m_iIndices = 6;
	_uint	indicies[6]{};
	indicies[0] = 0; indicies[1] = 1; indicies[2] = 2;
	indicies[3] = 0; indicies[4] = 3; indicies[5] = 2;
