...
private:
	...
	ID3D12Resource*				m_pConstantBufferUploadHeaps[m_iSwapchainBuffer];
...
public:
	ConstantBufferPerObject		m_tConstBufferPerObject;
	UINT8*						m_pConstantBufferGPUAddress[m_iSwapchainBuffer];
	int							m_iConstantBufferPerObjectAlignedSize = (sizeof(ConstantBufferPerObject) + 255) & ~255;
private:
