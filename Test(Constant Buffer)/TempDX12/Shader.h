...
public:
	...
	HRESULT							Complie_Shader();
	HRESULT							SetUp_OnShader(ID3D12PipelineState* pPipeline, _matrix matWorld, _matrix matView, _matrix matProj);
	HRESULT							SetUp_OnShader(ID3D12PipelineState* pPipeline, _matrix matWorld, _matrix matView, _matrix matProj, MAINPASS& tMain);
public:
